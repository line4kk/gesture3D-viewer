...
Пользователь управляет 3D-моделью с помощью естественных движений руки перед камерой: перемещение открытой ладони вращает модель, сведение двух рук приближает, движение - перемещает сцену. Никаких дополнительных контроллеров - только обычная веб-камера.
